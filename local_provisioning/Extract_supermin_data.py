...
CONCEPT = pd.read_csv('CONCEPT.csv', sep='\t', low_memory=False)

# Read CONCEPT_RELATIONSHIP data
CONCEPT_RELATIONSHIP = pd.read_csv('CONCEPT_RELATIONSHIP.csv', sep='\t', low_memory=False)

# Read CONCEPT_ANCESTOR data
CONCEPT_ANCESTOR = pd.read_csv('CONCEPT_ANCESTOR.csv', sep='\t', low_memory=False)

# Read CONCEPT_SYNONYM data
CONCEPT_SYNONYM = pd.read_csv('CONCEPT_SYNONYM.csv', sep='\t', low_memory=False)
...
CONCEPT_filtered_rows.to_csv("./app/data.supermin/CONCEPT/CONCEPT_filtered_rows.tsv", sep='\t', index=False)

CONCEPT_RELATIONSHIP_filtered_rows.to_csv("./app/data.supermin/CONCEPT_RELATIONSHIP/CONCEPT_RELATIONSHIP_filtered_rows.tsv", sep='\t', index=False)

CONCEPT_ANCESTOR_filtered_rows.to_csv("./app/data.supermin/CONCEPT_ANCESTOR/CONCEPT_ANCESTOR_filtered_rows.tsv", sep='\t', index=False)

CONCEPT_SYNONYM_filtered_rows.to_csv("./app/data.supermin/CONCEPT_SYNONYM/CONCEPT_SYNONYM_filtered_rows.tsv", sep='\t', index=False)
