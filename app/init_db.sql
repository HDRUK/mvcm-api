...
ALTER TABLE STANDARD_CONCEPTS ADD PRIMARY KEY (concept_id);
ALTER TABLE STANDARD_CONCEPTS ADD CONSTRAINT fk_concept_id FOREIGN KEY (concept_id) REFERENCES CONCEPT (concept_id);
